  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="ghost" size="icon" className="md:hidden -ml-2 text-[hsl(var(--sidebar-foreground))] hover:bg-transparent hover:text-white">
          <Menu className="w-6 h-6" />
        </Button>
      </SheetTrigger>
      <SheetContent side="left" className="p-0 w-[280px] bg-[hsl(var(--sidebar))] text-[hsl(var(--sidebar-foreground))] border-r border-white/10 z-[100]">
        {/* HEADER */}
        <SheetHeader className="h-24 flex flex-row items-center justify-start px-6 border-b border-white/5 space-y-0">
          <div className="flex items-center gap-3 w-full">
            ...
            <div className="flex flex-col text-left">
              <SheetTitle className="text-xl font-extrabold text-[hsl(var(--sidebar-foreground))] leading-none tracking-tight">
                Vegas
              </SheetTitle>
        ...
        {/* FOOTER */}
        <div className="p-3 border-t border-white/5 mt-auto w-full">
          <button
