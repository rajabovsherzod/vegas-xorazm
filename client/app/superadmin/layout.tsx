 ...
 * SuperAdmin Layout
 * 
 * Faqat admin va developer uchun
 */
...
import { superAdminNav } from "@/config/nav";
...
export default async function SuperAdminLayout({
  ...
  // Faqat admin yoki developer kirishi mumkin
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[hsl(var(--workspace))]">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden transition-all duration-300">
        {/* Header */}
        <Header user={session.user} rate={usdRate} navItems={superAdminNav} />
