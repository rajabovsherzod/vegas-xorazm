...
export function Header({ user, rate, navItems = [] }: HeaderProps) {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between border-b border-white/10 backdrop-blur-md px-4 sticky top-0 z-10 transition-all duration-300 bg-[hsl(var(--header))] text-[hsl(var(--header-foreground))]">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col">
          <h2 className="text-sm font-bold text-[hsl(var(--header-foreground))] capitalize leading-none">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-white/10">
          <div className="hidden md:block text-right">
            <p className="text-sm font-bold text-[hsl(var(--header-foreground))] leading-none">
              {displayName}
            </p>
